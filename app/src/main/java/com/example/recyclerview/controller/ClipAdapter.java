...
public class ClipAdapter extends RecyclerView.Adapter<ClipAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            layout = v;
            txtHeader = (TextView) v.findViewById(R.id.clip_header);
            img = (ImageView)v.findViewById(R.id.clip_icon);
            txtSecond = (TextView) v.findViewById(R.id.clip_second);
        }
    ...
    public void add(int position, Clip item) {
    ...
    public ClipAdapter(List<Clip> myDataset, MainActivity act) {
        values = myDataset;
        this.context = act;
    ...
    public ClipAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        LayoutInflater inflater = LayoutInflater.from(
                parent.getContext());
        View v =
                inflater.inflate(R.layout.row_layout_clip, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        final Clip clip = values.get(position);
        ...
        holder.txtHeader.setText(clip.getTitle());
        holder.txtSecond.setText("By " + clip.getCreator_name());
    }
